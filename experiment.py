...
def experiment(seed_x, seed_c):
    ...
    for Ec in Ec_variations:
        measures = service_simulator(simulation_time = 3600, arrival_rate = float(1/Ec), service_rate = float(1/Ex), seed_x=seed_x, seed_c=seed_c)
